...
{
  public   class LgImplOcCreadasAyer
    {
       ...
       private string _aprobado;
        ...
        private string _dsctoporcentaje;
        ...
        private string _valortotaldeltotaldelaorden;

        public LgImplOcCreadasAyer()
        {
        }

        public LgImplOcCreadasAyer(string tcProyecto, string tcProveedor, string tcCc, string tcTipoorden, string tcFpago, string tcEstadoorden, 
            string tcNroorden, string tcCodrecurso, string tcRecurso, string tcUnidad, string tcSimb, string tcCantidad, string tcCONTECHO,
            string tcPreciotecho, string tcPrecio, string tcPrecioexcedetecho, string tcDsctoporcentaje, string tcParcialrecurso, 
            string tcParcialtotalorden, string tcValordsctototalorden, string tcValornetototalorden, string tcValorigvtotalorden, 
            string tcValortotaldeltotaldelaorden, string tcRecursoafectadoconigv, string tcTipodecambio, string tcFechacreacion, 
            ...
            string tcFechaaprobacion, string tcObservacionorden, string tcObservaciondelrecurso)
        {
            ...
            this.Dsctoporcentaje = tcDsctoporcentaje;
            ...
            this.Valortotaldeltotaldelaorden = tcValortotaldeltotaldelaorden;
      ...
      public string Dsctoporcentaje
      {
          get { return _dsctoporcentaje; }
          set { _dsctoporcentaje = value; }
      }
      ...
      public string Valortotaldeltotaldelaorden
      {
          get { return _valortotaldeltotaldelaorden; }
          set { _valortotaldeltotaldelaorden = value; }
      }
    }
}
