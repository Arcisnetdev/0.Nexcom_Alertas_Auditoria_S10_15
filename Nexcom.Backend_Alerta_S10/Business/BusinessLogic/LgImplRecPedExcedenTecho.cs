namespace Nexcom.Backend_Alerta_S10.Business.BusinessLogic
{
    public class LgImplRecPedExcedenTecho
    {
        ...
        public LgImplRecPedExcedenTecho()
        {
        }

        public LgImplRecPedExcedenTecho(string tcProy, string tcAlm, string tcTped, string tcEped, string tcNpedm, string tcCodrec, string tcRec, string tcUn, string tcCped, string tcCtec, string tcXtec, string tcCxped, string tcObsped, string tcFped, string tcFapr, string tcUsreg, string tcUsapro, string tcEstor, string tcEstal, string tcEstcot)
        {
            this.Proy = tcProy;
            this.Alm = tcAlm;
            this.Tped = tcTped;
